...
from session_result import get_session_result, getLastResults, getNextGP
from drivers_standing import drivers_standing
from constructors_standing import constructors_standing   
from briefing import generate_briefing, get_briefing, raceData
...
app.add_api_route('/api/v1/getLastResults', getLastResults, methods=["GET"])
app.add_api_route('/api/v1/getNextGP', getNextGP, methods=["GET"])
...
app.add_api_route('/api/v1/raceData', raceData, methods=["GET"])
